(function() {
  var Age, AgeCalculator, Constants, Distance, ElapsedTime, RunWalkCalculator, Speed, root,
  ...
  Age = (function() {
    ...
    Age.prototype.training_zones = function() {
      var i, idx, len, max, pct, results, tuple, zones;
      results = [];
  ...
  RunWalkCalculator = (function() {
    function RunWalkCalculator() {}

    RunWalkCalculator.calculate = function(run_hhmmss, run_ppm, walk_hhmmss, walk_ppm, miles) {
      var avg_secs, avg_speed, avg_time, distance, mile, mph, proj_time, result, run_duration_elapsed_time, run_pct, run_ppm_elapsed_time, run_secs, total_secs, walk_duration_elapsed_time, walk_pct, walk_ppm_elapsed_time, walk_secs;
      result = {};
      if (run_hhmmss && run_ppm && walk_hhmmss && walk_ppm) {
